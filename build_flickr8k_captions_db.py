...
def main():
    ...
    with h5py.File(OUTPUT_PATH, "w") as hf:
        ...
        hf.create_dataset("captions",   data=np.array(all_captions,   dtype=h5py.special_dtype(vlen=str)))
        hf.create_dataset("filenames",  data=np.array(all_filenames,  dtype=h5py.special_dtype(vlen=str)))
